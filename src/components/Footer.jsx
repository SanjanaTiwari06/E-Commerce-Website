                ...
                <div className="row gy-5">
                    <div className="col-lg-3 col-sm-6">
                        <div className="footer-order">
                            <div className="logo">
                                <Link to='/'>
                                <img src="/public/images/logos/logo-dark.png" alt={import.meta.env_VITE_APP_SITE} height={100}/>
                                </Link>
                            </div>
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="links">
                            ...
                            <div className="footer-link useful-link">
                                <ul>
                                    <li><Link to="/PrivacyPolicy">Privacy-Pplicy</Link></li>
                            ...
                            <div className="footer-link contact-link">
                                <div className="address">
                                    ...
                                    <div className="details">
                                        ...
                                        <p>{import.meta.env.VITE_APP_ADRESS}</p>
                                    </div>
                                </div>
                                <div className="phone address">
                                    ...
                                    <div className="details">
                                        ...
                                        <p>{import.meta.env.VITE_APP_PHONE}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
