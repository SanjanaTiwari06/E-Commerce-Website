                ...
                <div className="row align-items-center gy-5">
                    <div className="col-lg-6">
                        <div className="about-img" data-aos="fade-right">
                            <img src="/public/images/banner5.jpg" alt="img"/>
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="about-content" data-aos="fade-up">
                            ...
                            <p className="about-info">
                                Apni Dukan is your trusted online shopping destination for quality products at affordable prices.
                                We offer a wide range of fashion, electronics, furniture, and daily essentials to meet every household need.
                                Our focus is on customer satisfaction, reliable quality, and a smooth shopping experience for everyone.</p>
                            <div className="about-list">
                                <ul>
                                    <li>
                                        ...
                                        <p>Wide range of quality products under one roof</p>
                                    </li>
                                    <li>
                                        <span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                        ...
                                        <p>Affordable pricing for every budget</p>
                                    </li>
                                    <li>
                                        <span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                        ...
                                        <p>Trusted quality and reliable service</p>
                                    </li>
                                    <li>
                                        <span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                        ...
                                        <p>Easy ordering and secure payment options</p>
                                    </li>
                                </ul>
                            </div>
