...
import { GetMainCatagory, DeleteMainCatagory } from '../../../Redux/ActionCreators/MainCatagoryActionCreators'
import { DELETE_MAINCATAGORY } from '../../../Redux/Constant'
...
let Dispatch = useDispatch() 
  ...
  useEffect(() => {
    let time = (() => {
      ...
      if(MainCatagoryStateData.length)
        setdata(MainCatagoryStateData)
        ...
        <div className="row g-4">   {/* g-0 important */}
          ...
          <div className="col-12 col-md-9 main-content text-center">
            <h5 className="text-light p-2" style={{ background: "#ae1c9a" }}>
              Main-catagory <Link to='/Admin/MainCatagory/Create'><i className='bi bi-plus fs-1 float-end text-light'></i></Link>
            </h5>
...
export default AdminMainCatagory