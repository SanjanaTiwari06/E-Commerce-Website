                                        ...
                                        <div className="col-sm-6">
                                            <div className="wrapper phone">
                                                ...
                                                <div className="wrapper-content">
                                                    ...
                                                    <p className="paragraph">{import.meta.env.VITE_APP_PHONE}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-sm-6">
                                            <div className="wrapper phone">
                                                ...
                                                <div className="wrapper-content">
                                                    ...
                                                    <p className="paragraph">{import.meta.env.VITE_APP_EMAIL}</p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="address">
                                                <div className="contact-address">
                                                    ...
                                                    <div className="address-content">
                                                        ...
                                                        <p className="paragraph">{import.meta.env.VITE_APP_ADRESS}</p>
                                                    </div>
                                                </div>
                                                <div className="contact-map">
                                                    <iframe
                                                        src={import.meta.env.VITE_APP_MAP2}
